...
export const THEME_BOOT = `(function(){try{var k=${JSON.stringify(THEME_KEY)};var t=localStorage.getItem(k);if(t==="organism")t="organizma";if(t!=="light"&&t!=="dark"&&t!=="organizma")t="light";var r=document.documentElement;r.setAttribute("data-theme",t);r.style.colorScheme=t==="light"?"light":"dark"}catch(e){document.documentElement.setAttribute("data-theme","light")}})();`
